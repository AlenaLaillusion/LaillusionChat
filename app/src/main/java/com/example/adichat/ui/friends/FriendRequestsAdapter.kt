...
import com.example.adichat.databinding.ItemFriendRequestBinding
import com.example.adichat.domain.friends.FriendEntity
import com.example.adichat.ui.core.BaseAdapter

open class FriendRequestsAdapter : BaseAdapter<FriendEntity, FriendRequestsAdapter.FriendRequestViewHolder>(FriendsAdapter.FriendsDiffCallback()) {
