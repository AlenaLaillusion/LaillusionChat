...
import com.example.adichat.presentation.Authenticator
import com.example.adichat.presentation.viewmodel.MediaViewModel
import com.example.adichat.remote.service.ApiService
import com.example.adichat.ui.account.AccountActivity
import com.example.adichat.ui.core.PermissionManager
import com.example.adichat.ui.home.HomeActivity
import com.example.adichat.ui.home.MessagesActivity
import com.example.adichat.ui.login.ForgetPasswordActivity
import com.example.adichat.ui.login.LoginActivity
...
@Singleton
class  Navigator   //вспом класс для запуска активити
@Inject constructor(
